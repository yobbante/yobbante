...
// TRANSPORTEURS / GP — ligne 926 (recrutement GP, support partenaires)
export const YOBBANTE_GP_WHATSAPP = '221789269756';
export const YOBBANTE_GP_WHATSAPP_DISPLAY = '+221 78 926 97 56';
