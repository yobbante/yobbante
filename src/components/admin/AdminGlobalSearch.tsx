...
const SECTION_ITEMS: Item[] = [
  ...
  { id: 'finances',      label: 'Finances & paiements',     section: 'finances', keywords: 'revenus ca chiffre affaire paiement gp wallet payout tva bilan' },
  { id: 'devis',         label: 'Devis',                    section: 'devis',    keywords: 'quote proposition pdf tarif' },
