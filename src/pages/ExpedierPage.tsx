 ...
 * /expedier/envoyer     → flow continu (no wizard) — SendFlow
 * /expedier/recevoir    → flow continu (no wizard) — ReceiveFlow
 */
export default function ExpedierPage() {
  ...
  if (mode === 'envoyer')  return <SendFlow />;
  if (mode === 'recevoir') return <ReceiveFlow />;
