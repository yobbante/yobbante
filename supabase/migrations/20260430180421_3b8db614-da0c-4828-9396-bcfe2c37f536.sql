-- Restaurer la marge plateforme initiale (+20% par rapport à la version réduite).
-- Avant : v_margin = 0.915 (réduit de 25%)
-- Après : v_margin = 1.22 (marge ~22%, version d'origine)
...
DECLARE
  ...
  v_margin numeric := 1.22; -- restauré (+20% vs 0.915)
